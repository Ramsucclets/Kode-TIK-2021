...
int main (int argc,char const*argv[])
{
 ...
 cout<<"//--------------------------------//\n";
 cout<<"Program Perhitungan Nilai siswa \n\n";
 cout<<"Masukan Nama siswa : ";cin.getline(nama, sizeof(nama));
...
cout<<"Nilai Tugas\t : "<<T<<endl; cout<<"Nilai UTS\t : "<<UT<<endl; cout<<"Nilai UAS\t : "<<UA<<endl; 
 if (nilai >= 90) {
  //Hasil Perhitungan
  cout<<"Skor  \t : A \n";
